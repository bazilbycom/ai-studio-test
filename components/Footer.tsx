  ...
  return (
    <footer className="pt-24 pb-12 px-6 border-t border-white/5 bg-black relative">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 gap-10">
            <div>
              ...
              <ul className="space-y-6 text-zinc-500 text-[10px] font-black uppercase tracking-widest">
                ...
                <li><a href="#services" className="hover:text-white transition-colors">Service Units</a></li>
                <li><a href="#portfolio" className="hover:text-white transition-colors">Archive</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-black uppercase tracking-[0.4em] text-[10px] text-[#10b981] mb-8">Protocols</h4>
              <ul className="space-y-6 text-zinc-500 text-[10px] font-black uppercase tracking-widest">
        ...
        {/* First Design Address Section Reverted */}
