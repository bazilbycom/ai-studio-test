        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-8">
              <div className="w-10 h-10 bg-gradient-to-tr from-cyan-500 to-purple-600 rounded-xl flex items-center justify-center font-black text-white italic text-xl">B</div>
              <span className="text-2xl font-bold tracking-tighter uppercase font-heading">Bycom<span className="text-cyan-400">Solutions</span></span>
            </div>
          ...
          <div>
            <h4 className="font-black uppercase tracking-widest text-xs text-white mb-6">Navigation</h4>
            <ul className="space-y-4 text-zinc-500 text-sm">
              <li><a href="#" className="hover:text-cyan-400 transition-colors">Home</a></li>
              <li><a href="#services" className="hover:text-cyan-400 transition-colors">Services</a></li>
              <li><a href="#ai-architect" className="hover:text-cyan-400 transition-colors">AI Architect</a></li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-zinc-500 text-sm">
              <li>General: contact@bycomsolutions.com</li>
              <li>Support: support@bycomsolutions.com</li>
              <li>Sales: +1 (555) 000-0000</li>
              <li className="mt-8">
                <div className="p-4 rounded-xl bg-white/5 border border-white/5">
                  <p className="text-[10px] text-zinc-400 uppercase tracking-widest mb-1">Status</p>
