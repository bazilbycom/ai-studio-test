    ...
    <nav className="fixed top-0 left-0 right-0 z-[60] flex justify-center p-6">
      <div className="glass-panel px-6 md:px-8 py-3 rounded-full flex items-center justify-between w-full max-w-6xl relative z-[70]">
        ...
        <div className="hidden md:flex items-center gap-8 text-[11px] font-black tracking-widest uppercase">
          ...
          <a 
            href="https://store.bycomsolutions.com" 
            target="_blank" 
            rel="noopener noreferrer"
            className="text-white hover:text-[#10b981] transition-colors flex items-center gap-1.5"
          >
            Products
          ...
          <a 
            ...
            className="px-6 py-2.5 bg-white text-black rounded-full hover:bg-[#10b981] transition-all hover:scale-105 active:scale-95 font-black ml-4"
          >
            Get Started
          </a>
        </div>
        ...
        <button 
          ...
          className="md:hidden text-white p-2 relative z-[80] focus:outline-none"
          aria-label="Toggle Menu"
        >
          <div className="w-6 flex flex-col gap-1.5">
            <motion.span 
              animate={isOpen ? { rotate: 45, y: 8 } : { rotate: 0, y: 0 }}
              className="h-0.5 w-full bg-[#10b981] block"
            ></motion.span>
            <motion.span 
        ...
        {isOpen && (
          ...
          >
            <div className="flex flex-col items-center gap-8">
              {navLinks.map((link, i) => (
                <motion.a
                  ...
                  className="text-4xl font-black uppercase tracking-tighter hover:text-[#10b981] transition-colors"
                >
                  {link.name}
                </motion.a>
              ))}
              <motion.a
                ...
                className="text-4xl font-black uppercase tracking-tighter text-[#10b981]"
              >
                Products
              </motion.a>
            </div>
            ...
            <motion.a
              ...
              onClick={() => setIsOpen(false)}
              className="mt-8 w-full max-w-xs text-center px-12 py-5 bg-[#10b981] text-black text-xl font-black uppercase rounded-2xl shadow-[0_0_30px_rgba(16,185,129,0.3)]"
            >
              Get Started
            </motion.a>
          </motion.div>
